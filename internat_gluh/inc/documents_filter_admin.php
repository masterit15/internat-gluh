<?
add_action('wp_ajax_docfiltersAdmin', 'docfiltersAdmin'); // wp_ajax_{ACTION HERE} 
add_action('wp_ajax_nopriv_docfiltersAdmin', 'docfiltersAdmin');
function docfiltersAdmin()
{

		...
		<form action="<? site_url() ?>/wp-admin/admin-ajax.php?action=application" class="application">
			...
			<div class="application_wrap">
				...
				<div class="specialists_filter">
					<div id="specialists_cat_wrap" class="specialists_filter_item">
						<?
					...
					<div id="specialists_select" class="specialists_filter_item">
						<?
					...
					<div class="specialists_filter_item">
				...
				<div class="specialists_shedule"></div>
				<div class="specialists_fields">
					...
					<div class="fields_group">
						<input type="number" class="input" name="age" id="age" required>
